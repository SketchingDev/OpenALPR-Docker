# OpenALPR Docker Image [![Build Status](https://travis-ci.org/FlyingTopHat/OpenALPR-Docker.svg?branch=master)](https://travis-ci.org/FlyingTopHat/OpenALPR-Docker)
